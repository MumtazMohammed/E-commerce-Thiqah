<template>
  <div class="TheShowRoomPage">
    <v-container class="pa-0 hidden-sm-and-down">
      ...
      <v-card max-height="400" flat class="mb-2 mt-3 pt-0 pa-2 overflow-y-auto">
        <v-card-title class="text py-1 grey--text text--darken-2">
          <v-icon color="green lighten-2" right>mdi-bullhorn</v-icon>
          تنبيهات
        </v-card-title>
        <v-card class="overflow-hidden" rounded="sm" outlined>
          <v-subheader class="Adv-titel pl-0 blue--text text--darken-1">
            هل أستطيع التعديل على التنسيقات؟
            <v-spacer></v-spacer>
          </v-subheader>
          <v-card-text class="Adv-text py-0 grey--text text--darken-1">
            بلا شك، يمكنك تغيير النصوص والصور، اختيار ألوانك الخاصة، ترتيب
            مكونات الصفحة بطريقتك، تغيير تقسيم الأعمدة… وأكثر، كل ذلك بالسحب
            والإدراج وملء الخانات. ويمكنك أيضاً استخدام التنسيق الواحد في أكثر
            من صفحة والتعديل عليها حسب ذوقك.
          </v-card-text>
          <v-card-text
            class="Adv-text py-0 text-center grey--text text--darken-1"
          >
            المزيد
          </v-card-text>
        </v-card>
      ...
      <!-- To Do list  -->
      <v-card color="transparent" flat class="overflow-hidden mb-2">
        <v-row no-gutters>
          <v-col
            md="6"
            lg="6"
            ...
            class="pa-1"
          >
            <v-card flat class="ToDoList-card">
        ...
        <v-row no-gutters>
          ...
          <v-col class="pa-2" cols="12" sm="6" md="6" lg="6">
            <v-card height="200">
              ...
              <v-card-text class="text-center text-featur pt-0 pa-2">
                قم بزيادة الطلبات من خلال تقديم أسعار مخفضة للمشترين عند الخروج
                باستخدام القسائم.
              </v-card-text>
            </v-card>
          </v-col>
