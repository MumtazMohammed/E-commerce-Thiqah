  ...
  <div class="UserAdd">
    ...
    <div class="">
      ...
      <v-container class="pa-0">
        <v-card flat tile min-height="100vh" color="" class="transparent">
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <v-chip
                        v-for="(date, i) in item.DateTime"
                        :key="i"
                        color="grey"
                        class="px-0 ma-1 text-truncate"
                        dark
                        small
                        style="max-width: 160px"
                      >
                        <v-card-text class="text-truncate pa-0 px-2 PerPrder">
                          {{ date }}
                        </v-card-text>
                      </v-chip>
                    </v-card-title>
                    ...
                    <v-card-actions class="justify-center">
                      <v-btn text width="180" class="btn2"> رؤية الطلب </v-btn>
                    </v-card-actions>
                  </v-card>
                </v-col>
              </v-row>
